...
class HashTable(object):
    ...
    def load_factor(self):
        ...
        Best and worst case running time: O(1) since we have access to the size and number of buckets in the class n"""
        return self.size / len(self.buckets)

    def keys(self):
        """Return a list of all keys in this hash table.
        Best and worst case running time: O(n) since the program have to traverse through the array and buckets"""
    ...
    def length(self):
        ...
        Best and worst case running time: O(1) because the program have a size attribute"""
    ...
    def contains(self, key):
        ...
        Best case running time: O(1) where the key is at the head of the index bucket
        Worst case running time: O(L) where L is the number of nodes in the bucket and if the key is at the last node"""
    ...
    def set(self, key, value):
        ...
        Best case running time: O(1) where the key is at the head of the index bucket
        Worst case running time: O(L) where L is the number of nodes in the bucket"""
        # Find the bucket the given key belongs in
        index = self._bucket_index(key)
        bucket = self.buckets[index]
        # Find the entry with the given key in that bucket, if one exists
